        ...
        <nav class="flex mt-0">
            <ol role="list" class="flex items-center space-x-0.5">
                ...
                <div class="flex items-center">
                    ...
                    <div class="-m-1">
                    <a href="{{route('course', $course->slug)}}" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700"> {{$course->platform->name}}</a>
                    </div>
                </div>
                </li>
            </ol>
        ...
        <div class="flex mt-8">
            ...
            <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                ...
                <div class="rounded-sm mt-8 shadow-sm bg-white">
                    <img src="{{$course->image}}" alt="Testing Laravel">
                    <div class="p-6">
            ...
            <div class="w-1/3 pl-10 pt-0">
                ...
                <a href="#" target="_blank" class="flex items-center justify-center w-full px-4 py-3 text-base font-bold text-center text-white transition-all duration-200 bg-red-500 border-2 border-transparent rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 hover:bg-white hover:text-black hover:border-b-2 hover:border-red-500"> 
                    Get the {{$course->type ? 'Book':'Courses '}}    
                    ...
                    <div class="px-4 py-5 sm:p-6">
                      ...
                      <div class="mt-8 flex flex-wrap gap-2.5">
                        @foreach ($course->series as $series )
                            <a href="{{route('series', $series->id)}}" class="relative inline-flex items-center rounded-full border border-gray-300 px-3 py-1.5 hover:bg-gray-100">
                            <div class="absolute flex flex-shrink-0 items-center justify-center">
                                <span class="h-1.5 w-1.5 rounded-full bg-rose-500" aria-hidden="true"></span>
                            </div>
